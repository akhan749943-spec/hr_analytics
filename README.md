...
!\[Dashboard Preview](visuals/hr\_analytics\_dashboard.png)
...
> Built an interactive HR dashboard with dynamic filtering, age-bin 

> controls, and drill-down visuals across department, education, 
...
\- Department-wise Attrition (donut)

\- Number of Employees by Age Group (adjustable bin size)

\- Job Satisfaction Rating by Job Role (matrix)

\- Education Field-wise Attrition (bar)
...
│ └── HR\_Analytics\_Dashboard.twbx

│

├── visuals/

│ └── hr\_analytics\_dashboard.png
